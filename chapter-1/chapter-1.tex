...
In this chapter, we start with a simple example of how a magnifying glass can be designed on paper. This section is added since nowadays the design is mostly done with professional software and story on how a lens can be designed from scratch based on theories is less clear. After that, we explain the modern optical approach with an emphasis on optimization techniques. The SPC method is briefly mentioned at the end of the chapter in comparison with other design/optimization techniques and it is elaborated in the next chapter. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%% SECTION 5 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusion}
In this chapter, we use the example of a magnifying glass to demonstrate how a lens can be designed on paper. However, nowadays the optical systems are getting too complicated to perform such analysis and design a lens from scratch. 

...
\section{Outlook}
To promote a design technique is can only be done through education and practice of the method. 

If there is a structure in the design space. It is very difficult to use the analytic method to make it clear given the limited amount of data. What is a structure? It is some abstract things defined by human. In this research, based on our intuitions, we have investigated individual cases, to look at what is the dynamics and changes in the design landscape when design practices is changing. What we observed is only numerous cases of scattered information where we hardly see a pattern of it. It can be concluded as all the problems/issues may happen when applying the saddle point construction for designing the lens systems. 
